...
@section('head')
    ...
    <script src="{{asset('asset/ventas/adminClientes.js')}}"></script>
...
@section('body')
    <section class="p-3">
        <div class="mb-4">
            <div class="m-auto" style="max-width: 400px;">
                <img src="{{asset('asset/img/modulo/clientes.png')}}" alt="Imagen de clientes" width="120px" class="img-fluid d-block m-auto">
    ...
    @include('intranet.ventas.modales.agregarCliente')
@endsection