...
@section('head')
    ...
    <script src="{{asset('asset/usuarios/modulo.js')}}"></script>
    <title>Modulos</title>
@endsection
@section('body')
    <section class="p-3">
        <div class="mb-4">
            <div class="m-auto" style="max-width: 300px;">
                <img src="{{asset('asset/img/modulo/modular.png')}}" alt="Imagen de modulo" width="120px" class="img-fluid d-block m-auto">
    ...
    @include('intranet.users.modales.roles')
@endsection