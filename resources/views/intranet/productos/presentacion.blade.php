...
@section('head')
    ...
    <script src="{{asset('asset/productos/adminPresentacion.js')}}"></script>
    ...
    <section class="p-3">
        <div class="mb-4">
            <div class="m-auto" style="max-width: 400px;">
                <img src="{{asset('asset/img/modulo/presentacion.png')}}" alt="Imagen de presentacion" width="120px" class="img-fluid d-block m-auto">
