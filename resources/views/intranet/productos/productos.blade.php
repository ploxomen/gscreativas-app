...
@section('body')
    <section class="p-3">
        <div class="mb-4">
            <div class="m-auto" style="max-width: 400px;">
                <img src="{{asset('asset/img/modulo/productos.png')}}" alt="Imagen de productos" width="120px" class="img-fluid d-block m-auto">
    ...
    @include('intranet.productos.modales.agregarProducto')
@endsection