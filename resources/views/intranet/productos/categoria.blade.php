...
@section('head')
    ...
    <script src="{{asset('asset/productos/adminCategoria.js')}}"></script>
    ...
    <section class="p-3">
        <div class="mb-4">
            <div class="m-auto" style="max-width: 400px;">
                <img src="{{asset('asset/img/modulo/categoria.png')}}" alt="Imagen de categorias" width="120px" class="img-fluid d-block m-auto">
