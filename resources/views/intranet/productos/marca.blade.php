...
@section('head')
    ...
    <script src="{{asset('asset/productos/adminMarca.js')}}"></script>
    <title>Marcas</title>
@endsection
@section('body')
    <section class="p-3">
        <div class="mb-4">
            <div class="m-auto" style="max-width: 400px;">
                <img src="{{asset('asset/img/modulo/marca.png')}}" alt="Imagen de marcas" width="120px" class="img-fluid d-block m-auto">
