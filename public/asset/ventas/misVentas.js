function loadPage(){
    ...
    const tablaDetalleVenta = document.querySelector("#idModaltablaDetalleVenta");
    ...
    function agregarDetalleVenta(indice,id,urlImagenProducto,nombreProducto,precio,vencimientos){
        ...
        <td><input type="number" name="producto_cantidad[]" min="1" data-tipo="cantidad" id="detalle-venta-producto-${id}-${textMayor}" class="form-control form-control-sm cambio-detalle" value="1"/></td>
    ...
    tablaVentas.onclick = async function(e){
        if (e.target.classList.contains("btn-outline-info")){
            try{
                ...
                idVenta = e.target.dataset.compra;
